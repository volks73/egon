...
(function () {
     ...
     * 
     * A bind parameter has a key, or placeholder, and a value. The value
     * replaces the placeholder when binding the parameters to a SQL statement.
     * This prevents SQL injection attacks because the value is never executed
     * as SQL.
     * 
     ...
     * @param {String}
     *            [key] - The key, or placeholder, for the literal value that
     *            will be replaced on binding.
     */
    ...
    /**
     * Adds a binary operator and its right operand to the tree. The left
     * operand is assumed to already be attached to the tree.
     * 
     * @param {OPERATORS}
     ...
     *            name and a {TableSource} is created automatically and added to
     *            the clause tree.
     */
     ...
     * 
     * @param {Array}
     *            columnNames - {String} elements. A new {Using} clause is
    ...
    /**
     * Either creates a named or indexed parameter. If the value is an object,
     * the property key is used as the named parameter; otherwise, an indexed
     ...
     * 
     * @param {Array}
     *            values - Elements are either {String} or {Object}. If
     *            {Object}, the property key is used as a named parameter for
     *            the value. If {String}, a placeholder indexed parameter is
     ...
     * @param {Values|Array}
     *            [values] - If {Array}, then a new {Values} clause is created
     *            and added.
     */
    ...
    /**
     * Returns a 'AS' clause if the 'value' is an object with one property and
     * the key is used as the alias.
     * 
     * @param {String|Object}
     ...
     *            the property key is used as the alias and an 'AS alias' clause
     ...
     * @param {Columns|Array}
     *            [columns] - If {Array}, then a new {Columns} clause is created
     *            and added.
     * @param {Values|Array}
     *            [values] - If {Array}, then a new {Values} clause is created
     *            and added.
     ...
     * 
     * @param {Array}
     *            names - The elements are {String} objects. The names of
     *            columns.
     * @param {Values|Array}
     *            [values] - If {Array}, then a new {Values} clause is created
     *            and added.
     ...
     *            {Object} will have one property where the key will be used as
     *            the named parameter.
     ...
     * 
     * @param {String|Source}
     *            source - The table name. Use an object literal with the key as
     *            the alias to implement an Ramis alias.
